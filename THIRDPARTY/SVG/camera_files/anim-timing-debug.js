...
YUI.add("anim-timing", function (Y) {
 ...
 */
sw.animation.Animate = function (config) {
    sw.animation.Animate.superclass.constructor.apply(this, arguments);
};

sw.animation.Animate.NAME = "sw.animation.Animate";

sw.animation.Animate.ATTRS = {
    transformTemplate: {
...
Y.extend(sw.animation.Animate, Y.Anim, {
    /**
     * Initializer.
     * @see Y.Base
     */
    initializer : function () {
        ...
        // constructor as well.
        this._superRun = sw.animation.Animate.superclass.run;
        this._superStop = sw.animation.Animate.superclass.stop;        
    },

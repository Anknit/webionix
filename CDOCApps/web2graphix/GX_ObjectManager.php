...
function GX_OBJ_AddNewSVGObject(&$respData)
{
	...
	switch($objectTypeVal)
	{
		case 'RECTANGLE':
			...
			break; 
		case 'IMAGE':
			$attrdefinition = array("id"=>$objectIDVal, "class"=>'SVG_SHAPE_OBJECT IMAGE ROTATE,0', 'x'=> '20','y'=>'20', 'width'=>'100', 'height'=>'100', 'transform'=>'translate(0 0) scale(1 1) rotate(0 0 0)', 'xlink:href'=>$imageURL, 'stroke'=>'black', 'stroke-width'=>'3','stroke-dasharray'=>'none', 'stroke-linejoin'=>'miter','stroke-opacity'=>'1', 'opacity'=>'1.0', 'fill'=>'none', 'fill-opacity'=>'1.0');
